...
import com.yildiz.serhat.favouriterecipesservice.controller.response.ApiResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse> handleBadRequestException(IllegalArgumentException exception) {
        ApiErrorType errorType = ApiErrorType.ILLEGAL_RECIPE_TYPE_EXCEPTION;
    ...
    public ResponseEntity<ApiResponse> handleNotFoundException(RecipeNotFoundException exception) {
        ApiErrorType errorType = ApiErrorType.RECIPE_NOT_FOUND_EXCEPTION;
    ...
    public ResponseEntity<ApiResponse> handleNotFoundException(IngredientNotFoundException exception) {
        ApiErrorType errorType = ApiErrorType.INGREDIENT_NOT_FOUND_EXCEPTION;
